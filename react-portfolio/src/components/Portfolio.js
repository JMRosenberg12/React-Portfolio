          ...
          <header>
              ...
              <div className="row">
                <div className="col-sm">
                    <img src="./images/WDScheduler.png" alt="Work Day Scheduler"> </img>
                ...
                <div className="col-sm">
                    <img src="./images/Project1.png" alt="Project 1"> </img>
                ...
                <div className="col-sm">
                  <img src="./images/NoteTaker.png" alt="Note Taker"> </img>
                ...
                <div className="col-sm">
                  <img src="./images/Project2.png" alt="Project 2"></img>

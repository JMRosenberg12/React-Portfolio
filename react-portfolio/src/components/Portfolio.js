          ...
          <header>
              ...
              <div className="row">
                <div className="col-sm">
                    <img className="./images/WDScheduler.png" alt="Work Day Scheduler"> </img>
                ...
                <div className="col-sm">
                    <img className="./images/PasswordGenerator.png" alt="Password Generator"> </img>
                ...
                <div className="col-sm">
                    <img className="./images/Project1.png" alt="Project 1"> </img>
                ...
                <div className="row">
                  <div className="col-sm">
                    <img className="./images/Burger.png" alt="Burger"> </img>
                ...
                <div className="col-sm">
                  <img className="./images/NoteTaker.png" alt="Note Taker"> </img>
                ...
                <div className="col-sm">
                  <img className="./images/Project2.png" alt="Project 2"></img>
